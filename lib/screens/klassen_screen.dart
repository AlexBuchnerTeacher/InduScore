...
class _KlassenScreenState extends ConsumerState<KlassenScreen> {
      ...
      body: Column(
        children: [
          ...
          KlassenFilterSection(
            ...
            onBerufeChanged: (berufe) => setState(() => _selectedBerufe = berufe),
            onSchuljahrChanged: (schuljahr) =>
                setState(() => _selectedSchuljahr = schuljahr),
          ),
  ...
  void _showKlasseDialog(BuildContext context, {Klasse? klasse}) {
    showDialog(
      context: context,
      builder: (context) => KlasseEditDialog(klasse: klasse),
    );
  }

  void _showDeleteDialog(BuildContext context, Klasse klasse) {
    showDialog(
      context: context,
      builder: (context) => KlasseDeleteDialog(klasse: klasse),
    );
  }
